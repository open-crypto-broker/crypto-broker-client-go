[![REUSE status](https://api.reuse.software/badge/github.com/open-crypto-broker/crypto-broker-client-go)](https://api.reuse.software/info/github.com/open-crypto-broker/crypto-broker-client-go)

# crypto-broker-client-go

## About this project

The Go client library for calling the crypto-broker.
